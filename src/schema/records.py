...
class SummarySchema:
    ...
    +----------+------------+-------+------------+------------------+---------------------------+---------------------------+--------------+---------------+-----+
    | uid      | dataset    | ppl   | lm_cc      | lm_cc_density    | avg_first_token_surprisal | avg_context_surprisal_gap | total_tokens | num_functions | loc |
    +----------+------------+-------+------------+------------------+---------------------------+---------------------------+--------------+---------------+-----+
    | 0a4af5.. | apr        | 1.05  | 12.4       | 6.2              | 0.12                      | 0.05                      | 150          | 2             | 12  |
    | HumanE_0 | humaneval  | 2.10  | 8.5        | 8.5              | 0.88                      | 0.10                      | 45           | 1             | 10  |
    +----------+------------+-------+------------+------------------+---------------------------+---------------------------+--------------+---------------+-----+
    """
    UID = "uid"
    DATASET = "dataset"
